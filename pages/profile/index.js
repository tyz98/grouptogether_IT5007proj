...
import { Box, MenuItem, Button, LinearProgress, Container, Autocomplete } from '@mui/material';
      ...
      <Container maxWidth="sm" styles={{marginTop: "30px"}}>
        <Formik
          ...
          onSubmit={(values, {setSubmitting, resetForm}) => {
            createProfile(values).then( res => { // 没有错误的响应：res是响应体中的数据
              setSubmitting(false)
            ...
            <Form>
              <Box margin={2}>
                <Field
                  ...
                  type="text"
                  label="Username"
                  helperText="Please enter a name for display"
                  InputLabelProps={{
                    shrink: true,
                  }}
